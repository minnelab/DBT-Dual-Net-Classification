...
class SEResNeXt(nn.Module):
    def __init__(self, block, layers, num_classes=2, cardinality=32):
...
def SE_ResNeXt50(num_classes=2, cardinality=32):
    return SEResNeXt(Bottleneck, [3, 4, 6, 3], num_classes, cardinality)
